...
class HourglassLayer(Layer):
    def __init__(
        ...
        self._hm1_output = None
        self._hm2_output = None
        self._residual_2j = None
        self._merge_feats_main = None
        self._merge_feats_1j = None
    ...
    def get_config(self):
        return {
            ...
            **{
                ...
                "feature_filters": self.feature_filters,
                "joints_filters_1J": self.joint_filters_1J,
                "joints_filters_2J": self.joint_filters_2J,
                "intermed": self.intermed,
                "skip_att": self.skip_att,
                "s2f_att": self.s2f_att,
                "f2s_att": self.f2s_att,
    ...
    def build(self, input_shape):
        ...
        self._hm2_output = HMOut(
            ...
            trainable=self.trainableD,
            outmax=None,
        ) if self.use_2jointHM else zeroLayer(self.joint_filters_2J,name="ZeroHeatmap2")
        #"""


        self._residual_2j = ResidualLayerIn(output_filters=self.feature_filters,
                                            name="Transit_Output",
                                            #dtype=dtype,
                                            #dynamic=dynamic,
                                            trainable=self.trainableD,
                                            epsilon=0.001,
                                            momentum=0.97,
        ) if self.use_2jointHM else zeroLayer(self.feature_filters,name="ZeroResidual2J")
        
        self._merge_feats_main = BatchNormConv1Layer(filters=self.feature_filters,
                                            kernel_size=1,
        ...
        self._merge_feats_1j = BatchNormConv1Layer(filters=self.feature_filters,
                                            kernel_size=1,
                                            name="Merge_Feats_1J",
                                            #dtype=dtype,
                                            #dynamic=dynamic,
